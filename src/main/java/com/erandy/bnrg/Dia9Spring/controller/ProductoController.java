...
public class ProductoController {
    ...
    private List<ProductoEntity> getProductos() {
    ...
    private ProductoEntity getById(@PathVariable("id") int id) {
    ...
    private ProductoEntity saveProducto(@RequestBody ProductoEntity productoEntity) {
    ...
    private void eliminarProducto(@PathVariable("id") int id) {
    ...
    private ProductoEntity actualizaProducto(@PathVariable("id") int id,
