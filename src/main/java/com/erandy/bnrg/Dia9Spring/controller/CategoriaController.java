...
public class CategoriaController {
    ...
    private CategoriaEntity getById(@PathVariable("id") int id) {
    ...
    private CategoriaEntity saveCategoria(@RequestBody CategoriaEntity categoriaEntity) {
    ...
    private void eliminarCategoria(@PathVariable("id") int id) {
    ...
    private CategoriaEntity actualizarCategoria(@PathVariable("id") int id,
